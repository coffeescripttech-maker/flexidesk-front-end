...
import OwnerRefundsPage from "./modules/Owner/Refunds/OwnerRefundsPage";
import OwnerReviewDashboard from "./modules/Owner/Reviews/OwnerReviewDashboard";
...
import AdminModerationPage from "./modules/Admin/Reviews/ModerationPage";
import ReviewAnalyticsDashboard from "./modules/Admin/Reviews/AnalyticsDashboard";
...
const router = createBrowserRouter([
  ...
  { path: "/owner/bookings", element: <RequireRole role="owner"><OwnerBookings /></RequireRole> },
  { path: "/owner/analytics", element: <RequireRole role="owner"><OwnerAnalyticsPage /></RequireRole> },
  { path: "/owner/inquiries", element: <RequireRole role="owner"><OwnerInquiries /></RequireRole> },
  { path: "/owner/transactions", element: <RequireRole role="owner"><OwnerTransactions /></RequireRole> },
  { path: "/owner/refunds", element: <RequireRole role="owner"><OwnerRefundsPage /></RequireRole> },
  { path: "/owner/reviews", element: <RequireRole role="owner"><OwnerReviewDashboard /></RequireRole> },
  ...
  { path: "/admin/login", element: <AdminLogin /> },
  {
    ...
    children: [
      ...
      { path: "reviews/moderation", element: <AdminModerationPage /> },
      { path: "reviews/analytics", element: <ReviewAnalyticsDashboard /> },
